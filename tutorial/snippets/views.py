...
# Class-based views with a very generic view from Tutorial 3:
...
# Class-based views with mixins from Tutorial 3:
...
# Class-based views from Tutorial 3:
...
# Function-based views from Tutorial 2:
